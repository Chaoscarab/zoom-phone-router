...
const mycaseParse = async (inputData) => {
    const dob = inputData.number1
    const spousedob = inputData.number2
    const dod = inputData.dateOfDeath
    const ssn = inputData.social
    ...
    let outObj = {dob: "01/01/1875", spousedob: "01/01/1875", mycaseID: "F", dateOfDeath: "01/01/1875", ssn: "00000000", name: inputData.name }
